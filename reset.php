...
<html lang="en">
<head>
<title>Systeme de gestion d'absences HEM</title>
<meta charset="UTF-8">
...
<div class="content">
    ...
    <h3>Reinitialiser mot de passe</h3>
      ...
      <div class="form-group">
          ...
          <label for="input1" class="col-sm-2 control-label">ton email</label>
          <div class="col-sm-10">
            <input type="email" name="email"  class="form-control" id="input1" placeholder="e-mail" />
          </div>
      </div>

      <input type="submit" class="btn btn-primary col-md-2 col-md-offset-10" value="Reinitialiser" name="reset" />
    </form>
      ...
      <?php
          ...
          if($row == 0){
?>
      <div  class="content"><p>Email non associe a aucun compte Contactez HEM directement</p></div>
